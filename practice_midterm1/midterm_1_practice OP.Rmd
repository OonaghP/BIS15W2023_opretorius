...
_I feel that we have learned how to extract information from both clean and messy data and then used that information to answer relevant questions about the datasets. We have also utilised data from numerous fields and sources and practiced with classmates from various fields, so that I think we could also say we have started working on the interdisciplinary part of the definition._

2. (2 points) What is the most helpful or interesting thing you have learned so far in BIS 15L? What is something that you think needs more work or practice? 

_I have found the data cleaning functions of the tidyverse most useful so far. I would like to practice more with summarise()._ 
