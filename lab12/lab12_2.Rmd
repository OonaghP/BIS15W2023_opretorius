...
## Practice
1. Open and save your finished homerange app from question 2 in part 1 as a stand alone `.R` script. What libraries are required for the app to run? Set the run method in the Run App drop down to "Run External".  *see homerange_app.R* You need tidyverse and shiny to run the app.
