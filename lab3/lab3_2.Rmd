...
```{r}
getwd()
fish <- readr::read_csv("/Users/pretoria/Desktop/BIS15W2023_opretorius-009126fe900d7272e06badb767a6e5c6a546f720/lab3/data/Gaeta_etal_CLC_data.csv")
```
If you don't want to use the full address, set the wd to where you want to be.
...
```{r}
setwd("/Users/pretoria/Desktop/BIS15W2023_opretorius-009126fe900d7272e06badb767a6e5c6a546f720/lab3/data/")
...
glimpse(mammals)
```
str() has more metadata than glimpse()
