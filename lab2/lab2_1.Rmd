...
>>>>>>> 21f4e094e7a9acf4275ee716ba9536d2d0b6a194
...
3. How do you interpret this result? What does this mean about NAs?  
This means that if you have NAs present, you will not be able to calculate the statistics, unless you remove them first.
>>>>>>> 21f4e094e7a9acf4275ee716ba9536d2d0b6a194
...
<<<<<<< HEAD
=======
It is useful because this code is making a rule that if any entry is NA, then they will be removed for the calculation to occur.

GENERAL NOTE: Any "rm" command will remove certain objects as specified.
>>>>>>> 21f4e094e7a9acf4275ee716ba9536d2d0b6a194
