...
=======
```{r}
my_vector_sequence[my_vector_sequence >= 50]
```

```{r}
my_vector_sequence[my_vector_sequence = 85]
```
...
=======
TotEarn <- colSums(all_harry_potter_matrix)
TotEarn
>>>>>>> 21f4e094e7a9acf4275ee716ba9536d2d0b6a194
```
...
=======
all_harry_potter_matrix2 <- rbind(all_harry_potter_matrix, TotEarn)
all_harry_potter_matrix2
>>>>>>> 21f4e094e7a9acf4275ee716ba9536d2d0b6a194
```
