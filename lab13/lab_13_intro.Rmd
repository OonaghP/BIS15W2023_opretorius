...
names(elephants)
```
First make a plot to visualise what you want:
```{r}
...
server <- function(input, output) {
  output$plot <- renderPlot({ #makes space in the ui for your plot you made in line 46
    filter(elephants, sex=input$sex) %>% #reactivity is part of the filter function
